...
class AnalysisDeliveryServiceTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.notifier.get_available_channels.return_value = [NotificationChannel.FEISHU]
        ...
        self.notifier.send_to_feishu.return_value = True
    ...
    def test_send_batch_notifications_sends_non_wechat_channels(self):
        ...
        self.notifier.send_to_feishu.assert_called_once_with("dashboard")
    ...
    def test_send_batch_notifications_skip_push_only_saves_report(self):
        ...
        self.notifier.send_to_feishu.assert_not_called()
