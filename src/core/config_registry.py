...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_SYNC_MARKETS": {
        "title": "Market Sync Markets",
        "description": "Comma-separated markets to sync, e.g. cn,hk,us.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ENABLE_REALTIME_QUOTE": {
        ...
        "description": "Enable realtime quote enrichment for analysis.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GEMINI_API_KEYS": {
        ...
        "description": "Comma-separated Gemini API keys for automatic failover.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GEMINI_PER_MODEL_RPM": {
        "title": "Gemini RPM Per Model",
        "description": "Per-model requests per minute limit for local throttling.",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GEMINI_PER_MODEL_DAILY_LIMIT": {
        "title": "Gemini Daily Limit Per Model",
        "description": "Per-model daily request limit for local quota protection.",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "LLM_RESPONSE_STYLE": {
        "title": "LLM Response Style",
        "description": "Runtime style for LLM wording compression (normal/caveman_lite/caveman_full/caveman_ultra).",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["normal", "caveman_lite", "caveman_full", "caveman_ultra"],
        "validation": {"enum": ["normal", "caveman_lite", "caveman_full", "caveman_ultra"]},
        "display_order": 59,
    },
    "OPENAI_MODEL": {
        "title": "OpenAI Model",
    ...
    "SCHEDULE_INTERVAL_MINUTES": {
        ...
        "description": "Run task every N minutes. When >0, interval mode overrides daily schedule time.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
